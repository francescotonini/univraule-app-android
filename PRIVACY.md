...
This page is used to inform users of "UniVR Aule" ("Application") regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Application.
